 ...
 * @method     UserQuery orderByUserGroupId($order = Criteria::ASC) Order by the user_group_id column
 * @method     UserQuery orderByUsername($order = Criteria::ASC) Order by the username column
 * @method     UserQuery orderByEmail($order = Criteria::ASC) Order by the email column
 * @method     UserQuery orderByPassword($order = Criteria::ASC) Order by the password column
 *
 * @method     UserQuery groupById() Group by the id column
 * @method     UserQuery groupByUserGroupId() Group by the user_group_id column
 ...
 * @method     User findOneByUserGroupId(int $user_group_id) Return the first User filtered by the user_group_id column
 ...
 * @method     array findByUserGroupId(int $user_group_id) Return User objects filtered by the user_group_id column
...
abstract class BaseUserQuery extends ModelCriteria
{
	 ...
	 * 
	 * @param     int|array $userGroupId The value to use as filter.
	 *            Accepts an associative array('min' => $minValue, 'max' => $maxValue)
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    UserQuery The current query, for fluid interface
	...
	public function filterByUserGroupId($userGroupId = null, $comparison = null)
	{
		if (is_array($userGroupId)) {
			...
			if (isset($userGroupId['min'])) {
				$this->addUsingAlias(UserPeer::USER_GROUP_ID, $userGroupId['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($userGroupId['max'])) {
				$this->addUsingAlias(UserPeer::USER_GROUP_ID, $userGroupId['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(UserPeer::USER_GROUP_ID, $userGroupId, $comparison);
	}
