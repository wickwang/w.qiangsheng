...
abstract class BaseLog extends BaseObject  implements Persistent
{
	...
	public function setCategory($v)
	{
		...
		if ($this->category !== $v) {
			$this->category = $v;
			$this->modifiedColumns[] = LogPeer::CATEGORY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = LogPeer::NUM_COLUMNS - LogPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LogPeer::CATEGORY)) $criteria->add(LogPeer::CATEGORY, $this->category);
