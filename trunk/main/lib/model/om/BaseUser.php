...
abstract class BaseUser extends BaseObject  implements Persistent
{
	...
	public function setUserGroupId($v)
	{
		...
		if ($this->user_group_id !== $v) {
			...
			$this->modifiedColumns[] = UserPeer::USER_GROUP_ID;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserPeer::USER_GROUP_ID)) $criteria->add(UserPeer::USER_GROUP_ID, $this->user_group_id);
	...
	{
		$copyObj->setUserGroupId($this->user_group_id);
