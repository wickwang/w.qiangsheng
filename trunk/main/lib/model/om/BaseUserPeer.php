...
abstract class BaseUserPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserGroupId', 'Username', 'Email', 'Password', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userGroupId', 'username', 'email', 'password', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_GROUP_ID, self::USERNAME, self::EMAIL, self::PASSWORD, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_GROUP_ID', 'USERNAME', 'EMAIL', 'PASSWORD', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_group_id', 'username', 'email', 'password', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserGroupId' => 1, 'Username' => 2, 'Email' => 3, 'Password' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userGroupId' => 1, 'username' => 2, 'email' => 3, 'password' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_GROUP_ID => 1, self::USERNAME => 2, self::EMAIL => 3, self::PASSWORD => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_GROUP_ID' => 1, 'USERNAME' => 2, 'EMAIL' => 3, 'PASSWORD' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_group_id' => 1, 'username' => 2, 'email' => 3, 'password' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(UserPeer::USER_GROUP_ID);
