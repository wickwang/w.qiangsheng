...
abstract class BaseLogPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'LogEventId', 'Category', 'Description', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'logEventId', 'category', 'description', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::LOG_EVENT_ID, self::CATEGORY, self::DESCRIPTION, self::CREATED_AT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'LOG_EVENT_ID', 'CATEGORY', 'DESCRIPTION', 'CREATED_AT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'log_event_id', 'category', 'description', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'LogEventId' => 1, 'Category' => 2, 'Description' => 3, 'CreatedAt' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'logEventId' => 1, 'category' => 2, 'description' => 3, 'createdAt' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::LOG_EVENT_ID => 1, self::CATEGORY => 2, self::DESCRIPTION => 3, self::CREATED_AT => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'LOG_EVENT_ID' => 1, 'CATEGORY' => 2, 'DESCRIPTION' => 3, 'CREATED_AT' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'log_event_id' => 1, 'category' => 2, 'description' => 3, 'created_at' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(LogPeer::CATEGORY);
