...
/**
 * This class defines the structure of the 'text_box' table.
 *
 *
 *
 ...
 */
class TextBoxTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.TextBoxTableMap';
	...
	{
	  // attributes
		$this->setName('text_box');
		$this->setPhpName('TextBox');
		$this->setClassname('TextBox');
